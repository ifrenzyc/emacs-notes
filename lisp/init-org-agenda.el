...
(use-package org-agenda
  ...
  (setq org-refile-targets '((org-agenda-file-inbox    :maxlevel . 1)
                             (org-agenda-file-work     :maxlevel . 2)
                             (org-agenda-file-personal :level .    2)
  ...
  (setq org-capture-templates
        '(
          ...
          ("a" "Appointment" entry (file+headline org-default-notes-file "Appointments")
           "* TODO %?\n:PROPERTIES:\n\n:END:\nDEADLINE: %^T \n %i\n")
          ("l" "Link" entry (file+headline org-agenda-file-inbox "Reading List")
           "* READ %^{Description}\n%u\n\n%c\n\n%i" :prepend t :empty-lines 1)
          ("l" "a link, for reading later." entry (file+headline org-agenda-file-inbox "Reading List")
           "* READ %?%^L %^g\n%T" :prepend t :empty-lines 1)
          ("K" "Cliplink capture task" entry (file+headline org-agenda-file-inbox "Reading List")
